...
//
// class ShareActivityAlert extends StatelessWidget {
//   const ShareActivityAlert({Key? key, required this.id, required this.bloc, required this.name})
//       : super(key: key);
//   final String id;
//   final String name;
...
//             children: [
//               Text(
//                 "هل تريد الانضمام الي هذا النشاط",
...
//                         bloc.add(JoinActivityEvent(id: id));
//                       },
//                       child: const Text(
//                         "نعم",
