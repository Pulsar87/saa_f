...
//
// class CancelActivityAlert extends StatelessWidget {
//   const CancelActivityAlert({Key? key, required this.id, required this.bloc, required this.name})
//       : super(key: key);
//   final String id;
...
//                         bloc.add(CancelActivityEvent(id: id));
//                       },
//                       child: const Text(
//                         "نعم",
